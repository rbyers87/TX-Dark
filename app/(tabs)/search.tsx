    ...
    <View style={[styles.container, { backgroundColor: Colors[colorScheme].background }]}>
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.content}>
        <View style={styles.header}>
          <Text style={[styles.title, { color: Colors[colorScheme].text }]}>Search Address</Text>
          <Text style={[styles.subtitle, { color: '#e0f2fe' }]}>Find jurisdiction for any Texas location</Text>
        </View>

        <View style={[styles.searchCard, { backgroundColor: Colors[colorScheme].background }]}>
          <View style={styles.searchHeader}>
            <Search size={20} color="#6b7280" />
            <Text style={[styles.searchTitle, { color: Colors[colorScheme].text }]}>Enter Texas Address</Text>
          </View>
        ...
        {locationData && searchedAddress && (
          <View style={[styles.resultsCard, { backgroundColor: Colors[colorScheme].background }]}>
            <View style={styles.addressHeader}>
              <MapPin size={20} color="#1e40af" />
              <Text style={[styles.addressTitle, { color: Colors[colorScheme].text }]}>Search Results</Text>
            </View>
            
            <View style={styles.addressContainer}>
              <Text style={styles.addressLabel}>Address:</Text>
              <Text style={[styles.addressText, { color: Colors[colorScheme].text }]}>{searchedAddress}</Text>
            </View>
