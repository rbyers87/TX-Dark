    ...
    <View style={[styles.container, { backgroundColor: Colors[colorScheme].background }]}>
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.content}>
        <View style={styles.header}>
          <Text style={[styles.title, { color: Colors[colorScheme].text }]}>Texas Law Enforcement</Text>
          <Text style={[styles.subtitle, { color: '#e0f2fe' }]}>Jurisdiction Finder</Text>
        </View>
        ...
        <View style={[styles.card, { backgroundColor: Colors[colorScheme].background }]}>
          <View style={styles.cardHeader}>
            ...
            <Text style={[styles.cardTitle, { color: Colors[colorScheme].text }]}>Current Location</Text>
